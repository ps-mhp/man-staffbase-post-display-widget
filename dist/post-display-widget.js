...
// UNUSED EXPORTS: POST_ID_ATTRIBUTE
...
;// ./src/widgets/post-display-widget/src/configuration-schema.ts
/*!
...
const uiSchema = {
  "post-id": {
    "ui:help": "ID des Beitrags aus Staffbase — die 24-stellige Zeichenfolge am Ende der Beitrags-URL. " + "Die vollständige URL kann ebenfalls eingefügt werden."
  }
};
;// ./src/widgets/post-display-widget/src/post-content.ts
 ...
 */
function pickLocalizedContent(contents, locales) {
...
;// ./src/widgets/post-display-widget/src/post-client.ts
/*!
 * Copyright 2026, MHP Management und IT-Beratung GmbH and contributors.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
;// ./src/widgets/post-display-widget/src/styles.ts
/*!
 * Copyright 2026, MHP Management und IT-Beratung GmbH and contributors.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
const STYLE_ELEMENT_ID = "post-display-widget-styles";
...
;// ./src/widgets/post-display-widget/src/post-view.tsx
/*!
 * Copyright 2026, MHP Management und IT-Beratung GmbH and contributors.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
function PostView({
  ...
  const [state, setState] = react.useState(postId === null ? {
    status: "error",
    message: MISSING_ID
  } : {
    status: "loading"
  ...
  react.useEffect(() => {
    ...
    fetchPost(postId).then(post => {
      ...
      setState({
        status: "error",
        message: `Beitrag konnte nicht geladen werden: ${reason}`
      });
    });
    return () => {
      current = false;
  ...
  if (state.status === "loading") {
    return /*#__PURE__*/react.createElement("div", {
      ...
      className: "post-display__status"
  ...
  return /*#__PURE__*/react.createElement("article", {
    ...
    html: title ?? "",
    className: "post-display__title"
  }), /*#__PURE__*/react.createElement(Html, {
    html: teaser ?? "",
    className: "post-display__teaser"
  }), /*#__PURE__*/react.createElement(Html, {
    html: content ?? "",
    className: "post-display__body"
  }));
}
;// ./src/widgets/post-display-widget/resources/post-display-widget.svg
/* harmony default export */ var post_display_widget = ("data:image/svg+xml;base64,");
;// ./src/widgets/post-display-widget/package.json
var package_namespaceObject = /*#__PURE__*/JSON.parse('{"rE":"0.1.0-rc.2","cy":""}');
;// ./src/widgets/post-display-widget/src/index.tsx
 ...
 */
const POST_ID_ATTRIBUTE = "post-id";

/** Attributes handled by the widget; mirrored in the configuration schema. */
const widgetAttributes = [POST_ID_ATTRIBUTE];
const factory = (BaseBlockClass, _widgetApi) => {
  return class PostDisplayWidgetBlock extends BaseBlockClass {
    constructor(...args) {
      super(...args);
    ...
    renderBlock(container) {
      ...
      this._root.render(/*#__PURE__*/react.createElement(PostView, {
        postId: postId
      }));
    }
